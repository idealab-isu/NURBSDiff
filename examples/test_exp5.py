...
def nurbs_reconstruction_loss(nu, nv, output, points, config, side=1):
    """
    ...
    output = output.view(config.batch_size, 10,10, 3)
...
config = Config('./train_open_spline_utils/configs/config_nips5_test.yml')
