...
config = Config('./train_open_spline_utils/configs/config_nips3_test_deg5.yml')
...
nu, nv = uniform_knot_bspline(5, 5, 2, 2, 40)
...
nurbs_layer = SurfEval(5,5, dimension=3, p=2, q=2, out_dim_u=40, out_dim_v=40, method='tc', dvc='cuda')
nurbs_layer.cuda()
