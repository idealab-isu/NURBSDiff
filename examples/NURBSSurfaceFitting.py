...
def main():
    ...
    if case=='Ducky':
        ...
        target = target_eval_layer(target_ctrl_pts).cuda().float()
        inp_ctrl_pts = torch.nn.Parameter(torch.rand((1,num_ctrl_pts1,num_ctrl_pts2,4), requires_grad=True).cuda().float())
