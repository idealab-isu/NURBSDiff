...
config = Config('./train_open_spline_utils/configs/config_nips1_test_deg4.yml')
...
nu, nv = uniform_knot_bspline(20, 20, 4, 4, 40)
...
nurbs_layer = SurfEval(20,20, dimension=3, p=4, q=4, out_dim_u=40, out_dim_v=40, method='tc', dvc='cuda')
nurbs_layer.cuda()
