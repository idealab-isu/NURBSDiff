...
# exchange.export_stl(surf, 'smesh.1.stl')

exchange.export_stl(surftest[0], 'RoofBottom.stl')
...
exchange.export_smesh(surf, 'smesh.2.dat')
# exchange.export_stl(surf, 'smesh.2.stl')
