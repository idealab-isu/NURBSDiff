...
config = Config('./train_open_spline_utils/configs/config_nips2_test_deg4.yml')
...
nu, nv = uniform_knot_bspline(10, 10, 4, 4, 40)
...
nurbs_layer = SurfEval(10,10, dimension=3, p=4, q=4, out_dim_u=40, out_dim_v=40, method='tc', dvc='cuda')
nurbs_layer.cuda()
