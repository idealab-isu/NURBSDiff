...
import sys
import time
from PyQt5.QtWidgets import QApplication, QTabWidget, QMainWindow, QProgressBar, QComboBox, QVBoxLayout, QPushButton, QWidget, QFileDialog, QSplitter, QHBoxLayout, QTextEdit, QMessageBox, QLabel, QSpinBox
...
class DemoApp(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.combo.addItem("output")
        self.combo.addItem("control points")
        self.combo.currentIndexChanged.connect(self.onComboIndexChanged)
        ...
        lap_label = QLabel("Laplacian: ")
        lap_layout.addWidget(lap_label)
        lap_layout.addWidget(self.combo)
        spin_box_layout.addLayout(lap_layout)
    ...
    def onComboIndexChanged(self, index):
        self.selected_option = self.combo.itemText(index)
    ...
    def load_point_cloud(self):
        ...
        if file_name:
            ...
            with open(file_name, 'r') as f:
                ...
                # skip the first line
                lines = lines[2:self.sampled_resolution * self.sampled_resolution + 2]
    ...
    def run_algorithm_unsupervised(self):
        ...
        try:
            unsupervised(self.selected_option, self.progress_bar, 
    ...
    def run_algorithm_supervised(self):
        try:
            self.fig = supervised(self.progress_bar ,self.fig, epoch=1000,
    ...
    def remove_point_clouds(self):
        ...
        self.unsupervised_output_widget.remove_actor('output_point_cloud_ctrlpts')
    #     self.fig.clear()
    #     self.fig.
