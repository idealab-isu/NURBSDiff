...
def gen_control_points(no_of_curves,no_of_ctrl_pts):
    ctrl_pts = torch.rand(no_of_curves,no_of_ctrl_pts,3,requires_grad=True,dtype=torch.float32,device='cuda')
    ...
    ctrl_pts[:,:,2] = torch.ones(no_of_ctrl_pts,dtype=torch.float32,device='cuda')
